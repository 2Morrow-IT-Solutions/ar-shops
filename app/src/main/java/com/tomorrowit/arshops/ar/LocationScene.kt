package com.tomorrowit.arshops.ar

import android.app.Activity
import android.os.Handler
import android.util.Log
import com.tomorrowit.arshops.ar.rendering.LocationNode
import com.tomorrowit.arshops.ar.sensor.DeviceLocation
import com.tomorrowit.arshops.ar.sensor.DeviceLocationChanged
import com.tomorrowit.arshops.ar.sensor.DeviceOrientation
import com.tomorrowit.arshops.ar.utils.LocationUtils
...
class LocationScene(var context: Activity, var mArSceneView: ArSceneView) {
    ...
    private fun refreshAnchorsIfRequired(frame: Frame) {
        ...
        for (i in mLocationMarkers.indices) {
            try {
                ...
                markerBearing %= 360
                val rotation = floor(markerBearing.toDouble())
                Log.d(
                ...
                val z = -min(renderDistance.toFloat(), RENDER_DISTANCE)
                ...
                marker.anchorNode?.parent = mArSceneView.scene
                ...
                if (markerDistance > RENDER_DISTANCE) {
                    val renderHeight = RENDER_DISTANCE * marker.height / markerDistance
                    marker.anchorNode?.height = renderHeight
                } else {
